...
from AEs.llm.encoder_decoder import AE_Module
...
class llm_Nemo_Model(ModelInterfaceBase[MegatronModelType, MegatronLossType]):
    ...
    def loss_fn(self, batch):
        ...
        # TGT VAE Loss
        tgt_recon = self.module(tgt_batch)
        ...
        # final_loss = tgt_vae_mse + tgt_vae_mmd
        # log_info = {"tgt_vae_mse": tgt_vae_mse.item(), "tgt_vae_mmd": tgt_vae_mmd.item(), "final_loss": final_loss.item()}
        final_loss = src_vae_mse + src_vae_mmd + tgt_vae_mse + tgt_vae_mmd
