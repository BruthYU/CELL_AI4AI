...
from AEs.llm_sets_plus.encoder_decoder import AE_Module
...
class llm_sets_plus_Nemo_Model(ModelInterfaceBase[MegatronModelType, MegatronLossType]):
    ...
    def loss_fn(self, batch):
        ...
        log_info = {"tgt_vae_mse": tgt_vae_mse.item(), "tgt_vae_mmd": tgt_vae_mmd.item(), "tgt_cls_loss": tgt_cls_loss.item(), "final_loss": final_loss.item()}
