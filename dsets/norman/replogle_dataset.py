...
class Norman_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        sample = {
            "batch_onehot": self.onehot_from_str_np(batch, self.global_keys["batch"]),
            "cell_type_onehot": self.onehot_from_str_np(cell_line, self.global_keys["cell_line"]),
            "pert_onehot": self.onehot_from_str_np(gene, self.global_keys["gene"]),
            "control_onehot": self.onehot_from_str_np(self.control_pert, self.global_keys["gene"]),
