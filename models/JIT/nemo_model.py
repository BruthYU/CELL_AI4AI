...
from models.JIT.flow.interpolant import Interpolant
# Velocity Field
from models.JIT.networks._nemo_vf import ConditionalVelocityField
import models.JIT.networks._basic as nn_basic
...
class metrics:
    def __init__(self):
        ...
        # self.mmd = Transpose_MMDLoss(kernel="energy", scale=1.0)
...
class JIT_Nemo_Model(ModelInterfaceBase[MegatronModelType, MegatronLossType]):
