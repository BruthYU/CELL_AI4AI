...
from models.JIT_LLM.flow.interpolant import Interpolant
# Velocity Field
from models.JIT_LLM.networks._nemo_vf import ConditionalVelocityField
import models.JIT_LLM.networks._basic as nn_basic
...
class JIT_LLM_Nemo_Model(ModelInterfaceBase[MegatronModelType, MegatronLossType]):
