...
from models.JIT_LLM_GENE.flow.interpolant import Interpolant
# Velocity Field
from models.JIT_LLM_GENE.networks._nemo_vf import ConditionalVelocityField
import models.JIT_LLM_GENE.networks._basic as nn_basic
...
class JIT_LLM_GENE_Nemo_Model(ModelInterfaceBase[MegatronModelType, MegatronLossType]):
    ...
    def loss_fn(self, batch):
        ...
        src_encoded_map = src_batch
        tgt_encoded_map = tgt_batch
