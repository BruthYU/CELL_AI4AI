...
from models.PRIOR.flow.interpolant import Interpolant
# Velocity Field
from models.PRIOR.networks._nemo_vf import ConditionalVelocityField
...
class PRIOR_Nemo_Model(ModelInterfaceBase[MegatronModelType, MegatronLossType]):
    ...
    def loss_fn(self, batch):
        ...
        tgt_loss = tgt_vae_mse + tgt_vae_mmd
        src_loss = src_vae_mse + src_vae_mmd
