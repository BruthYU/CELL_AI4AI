...
class CellMapEncoder(nn.Module):
    def __init__(self, conf: dict):
        ...
        print(gene_transformer_conf)
        self.gene_transformer = TransformerEncoderBlock(gene_transformer_conf)
...
class CellMapDecoder(nn.Module):
    def __init__(self, conf: dict):
        ...
        # Keep the decoder symmetric with encoder: transformer-based token mixing.
        gene_transformer_conf = {
            "input_dim": self.input_dim,
            "d_model": self.dims[-1],
        }
...
class TransformerEncoderBlock(nn.Module):
    ...
    def __init__(self, conf: dict | None):
        ...
        self.act_fn = self.conf.get("act_fn", "gelu")
