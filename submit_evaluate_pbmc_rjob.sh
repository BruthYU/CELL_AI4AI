...
RUN_SCRIPT="${PROJECT_DIR}/run_evaluate_pbmc_rjob.sh"
...
rjob submit \
  ...
  -e PBMC_OUT_SUBFOLDER=results_calibrate \
  -e PBMC_CELLTYPE_COL=celltype \
  -e PBMC_NUM_THREADS=32 \
  -e PBMC_SKIP_METRICS=pearson_edistance,clustering_agreement \
